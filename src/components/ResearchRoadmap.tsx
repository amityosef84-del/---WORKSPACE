...
const STAGES: StageConfig[] = [
  ...
  {
    id: 6, icon: "📊",
    title: "ניתוח פערים שיווקי",
    subtitle: "Google Ads, Social, Lead Magnets",
    estimatedSeconds: 45,
    microTasks: [
      { label: "סורק נוכחות שיווקית של המתחרים" },
      { label: "ממפה ערוצי שיווק פעילים" },
      { label: "מזהה פערים ביחס לעסק שלך" },
